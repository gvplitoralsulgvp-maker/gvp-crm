...
const Layout: React.FC<{ 
  ...
  const menuItems = [
    ...
    { to: "/mural", label: "Mural", icon: "M19 20l-7-7 7-7" }, // Ícone aproximado
  ...
  // Substituindo ícone do mural para ser mais adequado (ícone de chat/balão)
  menuItems[3].icon = "M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z";
      ...
      <div className="flex-grow flex flex-col min-w-0 h-full relative overflow-hidden">
        ...
        <main className="flex-grow overflow-y-auto custom-scrollbar p-4 md:p-6 bg-transparent">
          <Routes>
            ...
            <Route path="/training" element={<ElearningPage state={state} isHospitalMode={isHospitalMode} />} />
